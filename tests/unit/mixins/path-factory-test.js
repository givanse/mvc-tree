...
module('mixin:path-factory', function() {
  // Replace this with your real tests.
  test('it works', function(assert) {
    var PathFactoryObject = EmberObject.extend(PathFactoryMixin);
  ...
  test('_genPathC2C 5x5', function(assert) {
    ...
    //let x = 150, y = 200;
    let result = subject._genPathC2C(1, 1, 3, 3);
    let expected = 'h100 v100';
  ...
  test('_orderNodes', function(assert) {
    ...
    var a = EmberObject.create({col: 1, row: 1});
    var b = EmberObject.create({col: 1, row: 1});
    ...
    a = EmberObject.create({col: 1, row: 1});
    b = EmberObject.create({col: 2, row: 0});
    result = subject._orderNodes(a, b);
    expected = {a: a, b: b};
    assert.deepEqual(result, expected, '1,1 2,0');

    a = EmberObject.create({col: 1, row: 1});
    b = EmberObject.create({col: 2, row: 1});
    result = subject._orderNodes(a, b);
    expected = {a: a, b: b};
    assert.deepEqual(result, expected, '1,1 2,1');

    a = EmberObject.create({col: 1, row: 1});
    b = EmberObject.create({col: 1, row: 2});
    result = subject._orderNodes(a, b);
    expected = {a: a, b: b};
    assert.deepEqual(result, expected, '1,1 1,2');

    a = EmberObject.create({col: 1, row: 1});
    b = EmberObject.create({col: 2, row: 2});
    result = subject._orderNodes(a, b);
    expected = {a: a, b: b};
  ...
  test('generateBindingPath 3x2 simple', function(assert) {
    ...
    // #__
    // ___
    var a = EmberObject.create({col: 0, row: 0, x: 0, y: 0});
    var b = EmberObject.create({col: 0, row: 0, x: 0, y: 0});
    ...
    // ##_
    // ___
    a = EmberObject.create({col: 0, row: 0, x:  0, y: 0});
    b = EmberObject.create({col: 1, row: 0, x: 40, y: 0});
    ...
    // ___
    a = EmberObject.create({col: 0, row: 0, x: 0, y: 0});
    b = EmberObject.create({col: 2, row: 0, x: 80, y: 0});
    result = subject.generateBindingPath(a, b);
    ...
    // __#
    a = EmberObject.create({col: 0, row: 0, x: 0, y: 0});
    b = EmberObject.create({col: 2, row: 1, x: 0, y: 0});
    result = subject.generateBindingPath(a, b);
    ...
    // __#
    // #__
    a = EmberObject.create({col: 0, row: 1, x: 0, y: 40});
    b = EmberObject.create({col: 2, row: 0, x: 80, y: 0});
    result = subject.generateBindingPath(a, b);
    ...
    // __
    // _#
    a = EmberObject.create({col: 1, row: 0, x: 40, y: 0});
    b = EmberObject.create({col: 1, row: 2, x: 40, y: 80});
    result = subject.generateBindingPath(a, b);
  ...
  test('generateBindingPath MVVM - Data Binding', function(assert) {
    ...
    var a = EmberObject.create({col: 3, row: 14, x: 540,  y: 1120});
    var b = EmberObject.create({col: 6, row: 7,  x: 1080, y: 560});
    var result = subject.generateBindingPath(a, b);
