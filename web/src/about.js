...
import './styles.css';
import { renderNavbar } from './chrome.js';

renderNavbar(document.getElementById('site-nav'), { page: 'about' });
...
document.getElementById('app').innerHTML =
  '<div class="container about-page">' +
    ...
    '<div class="panel panel-success">' +
      ...
      '<div class="panel-body">' +
        ...
        '<p>' +
          ...
          '<a target="_blank" href="http://paulhammant.com/2015/04/29/mvc-misunderstood-for-37-years/">MVC: misunderstood for 37 years </a>. ' +
          'It goes into more detail about the technical aspects.' +
        '</p>' +
      '</div>' +
    '</div>' +
    ...
    '<div class="panel panel-success">' +
      ...
      '<div class="panel-body">' +
        '<p>' +
          'A static Vite app draws the tree with SVG. Path and grid math live in ' +
          '<code>app/lib/svg-layout</code> (no Ember). Encyclopedia copy is still the Handlebars partials under ' +
          '<code>app/templates</code>; the shell ports <code>{{link-to-blank}}</code> to ordinary links.' +
        '</p>' +
        '<p>' +
          'Pull requests are welcome. These are the files where you would add or edit content:' +
          '<ul>' +
            '<li>' +
              '<a href="https://github.com/givanse/mvc-tree/tree/master/app/jsons">app/jsons</a>' +
            '</li>' +
            '<li>' +
              '<a href="https://github.com/givanse/mvc-tree/tree/master/app/templates/dpatterns">app/templates/dpatterns</a>' +
            '</li>' +
            '<li>' +
              '<a href="https://github.com/givanse/mvc-tree/tree/master/app/templates/technologies">app/templates/technologies</a>' +
            '</li>' +
          '</ul>' +
        '</p>' +
        '<p>' +
